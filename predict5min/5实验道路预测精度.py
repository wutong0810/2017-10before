...
for i in range(7):
    plt.subplot(2,4,i+1)
    plt.plot(np.linspace(0,24,288),state.iloc[i*288:(i+1)*288,3],'o-',markersize=3,label='true') 
    plt.plot(np.linspace(0,24,288),state.iloc[i*288:(i+1)*288,4],'o-',markersize=3,label='predict')
    plt.legend()
    plt.ylim(0,4)
