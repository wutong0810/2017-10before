...
ax.set_xticklabels(['t-1',u'所处的时刻','$\Delta$t-1','t-4',r'$\Delta$t-2',r'$\Delta$t-3','u_t-2','t-2','t-3','u_t-1',u'星期'], fontsize=12,rotation=50) 
ax.set_ylabel(u'重要性',fontsize=13)
sns.despine() 
plt.savefig('d:/picture/importance.png',dpi=200) 
...
ax.set_xticklabels(('time of day','t-4','t-3','t-2',,r'$\delta$t-3',r'$\delta$t-2',r'$\delta$t-1','u_t-2','u_t-1','weekends'),frontsize=12)
