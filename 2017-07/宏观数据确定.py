...
#GDP所有数据
#search(allname=codetotal1,filename=r'D:\Data\数据\2017-07\20170704铁四院经调\20170706杭临绩项目\经济数据.txt',stDate=2000,enDate=2016,cicode=330000)



search(allname=codeTotalFinal,filename=r'D:\Data\数据\2017-07\20170704铁四院经调\20170706杭临绩项目\所有数据3.txt',stDate=2000,enDate=2016,cicode=330000)
