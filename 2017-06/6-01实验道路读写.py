...
zh_zy1=zh_zy.iloc[:,[1,2,6,7,0]]
zh_zy1.to_csv(r'f:\data_final\zh_zy1201_1231.csv',index=False)


#6.中华路- 都司路
ds_zy=pd.read_csv(r'F:\data\zh_ds1201-1231.csv')
ds_zy1=ds_zy.iloc[:,[1,2,6,7,0]]
ds_zy1.to_csv(r'f:\data_final\ds_zy1201_1231.csv',index=False)
